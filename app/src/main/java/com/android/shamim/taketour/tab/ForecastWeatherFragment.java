...
import com.android.shamim.taketour.ForecastWeatherResponse;
        ...
        call.enqueue(new Callback<ForecastWeatherResponse>() {
            ...
            public void onResponse(Call<ForecastWeatherResponse> call, Response<ForecastWeatherResponse> fresponse) {
                if(fresponse.code() == 200){
                    ...
                    // Toast.makeText(MainActivity.this,"Forcast data with " +forecastList.size() , Toast.LENGTH_LONG).show();
                   //  Toast.makeText(getActivity(),"Forcast data with:  " +forecastList.size() , Toast.LENGTH_LONG).show();
