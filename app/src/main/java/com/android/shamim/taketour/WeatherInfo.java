...
import com.android.shamim.taketour.helper.WeatherTabAdapter;
...
public class WeatherInfo extends AppCompatActivity {
   ...
   Bundle bundle;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        CurrentWeatherFragment fragInfo = new CurrentWeatherFragment();
        fragInfo.setArguments(bundle);
      //  fragmentManager.beginTransaction().replace(R.id.pager, fragInfo).commit();
    ...
    public  void  getLatLonByCity( String city) {
      ...
      /*
        try {
            final List<Address> fromLocationName = geocoder.getFromLocationName(city,2);
             lat = fromLocationName.get(0).getLatitude();
             lon = fromLocationName.get(0).getLongitude();
